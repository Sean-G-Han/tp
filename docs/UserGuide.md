...
- `list` followed by `delc 2` deletes the 2nd person in the address book.
- `findclient Betsy` followed by `delc 1` deletes the 1st person in the results of the `findclient` command.
